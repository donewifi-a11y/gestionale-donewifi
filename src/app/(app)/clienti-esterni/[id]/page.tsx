      ...
      <div className="mb-5 grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="rounded-2xl border bg-card p-5 shadow-md">
          ...
          <div className="flex flex-col gap-2 text-sm">
            ...
            <div className="mt-1 grid grid-cols-2 gap-2 border-t pt-2 text-xs text-muted-foreground">
        ...
        <div className="rounded-2xl border bg-card p-5 shadow-md">
          <h2 className="mb-3 font-heading text-sm font-bold">Contratto &amp; profilo</h2>
          <p className="mb-3 text-sm"><span className="text-muted-foreground">Profilo attuale: </span><span className="font-semibold">{c.profilo_internet || "—"}</span></p>
          ...
          {storico.length === 0 && (
            <p className="mt-1 text-xs text-muted-foreground">Nessun cambio rilevato ancora (lo storico parte da quando è nata questa pagina).</p>
          )}
