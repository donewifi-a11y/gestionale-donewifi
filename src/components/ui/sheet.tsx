  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          // ★ FIX — mancava un overflow-y: un pannello con più contenuto
          // dell'altezza dello schermo (frequente ora che il dettaglio
          // Ticket/Segnalazione ha più sezioni/pulsanti) restava "tagliato"
          // oltre il bordo della finestra senza alcun modo di scorrere fino
          // in fondo — non solo qui, in ogni Sheet dell'app. Lo scroll va
          // sul contenuto (sotto), non su tutto il pannello: altrimenti la
          // X per chiudere scorrerebbe via insieme al resto invece di
          // restare sempre raggiungibile in alto a destra.
